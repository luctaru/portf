...
app.get('/interesses', (req, res) => {
    db.all('SELECT name FROM interesses', (err, rows) => {
        console.log(rows);
...
app.get('/interesses/:intid', (req, res) => {
    ...
    db.all(
        'SELECT * FROM interesses WHERE name=$name',
        {
            $name: nomeProcurado
        },
        (err, rows) => {
...
app.post('/interesses/ins', (req, res) => {
    ...
    db.run(
        'INSERT INTO interesses VALUES ($name)',
        {
            $name: req.body.name,
        },
        (err) => {
...
app.get('/interesses/rm/:intid', (req, res) => {
    ...
    const nomeProcurado = req.params.intid;
    db.all(
        'DELETE FROM interesses WHERE name=$name',
        {
            $name: nomeProcurado
        },
        (err, rows) => {
...
app.get('/interesses/alt/:intold/:intnew', (req, res) => {
    ...
    db.all(
        'UPDATE interesses SET name = $new WHERE name=$old',
        {
            $new: nomeAlterado,
            $old: nomeProcurado
        },
...
app.get('/perfil/alt/:perfID/:perfMiniNew/:perfFotoNew/:portCurriNew', (req, res) => {
    ...
    db.all(
        'UPDATE perfil SET minibio = $mini, foto = $foto, curri = $curri WHERE id=$id',
        {
            $mini: miniAlterado,
            $foto: fotoAlterado,
            $curri: curriAlterado,
...
app.post('/perfil/ins', (req, res) => {
    ...
    db.run(
        'INSERT INTO perfil (minibio, foto, curri) VALUES ($mini, $foto, $curri)',
        {
            $mini: req.body.minibio,
            $foto: req.body.foto,
