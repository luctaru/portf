$(document).ready(function () {
            ...
            $.ajax({      
                ...
                success: (data) => {
                    ...
                    if (data) {
                        console.log(data)
                        $('#perfStatus').html('');
                        $('#perfStatus').append("<ul><li>" + data.minibio + "</li><li><img src='../img/" + data.foto + "' width='200px'></img></li><li><a href = '" + data.curri + "' target='_blank'>Curriculo</a></li><ul>");
                        $('#perfIDBox').val('');
                    } else {
            ...
            success: (data) => {
                ...
                if (data) {
                    ...
                    data.forEach(element => {
                        $('#listaPerf').append("<li>" + element.minibio + "</li><li><img src='../img/" + element.foto + "' width='200px'></img></li><li><a href = '" + element.curri + "' target='_blank'>Curriculo</a></li><br />");
                    });
                    $('#perfIDBox').val('');
                } else {
    ...
    $('#perfAltButton').click(() => {
        $('#perfStatus').html('');
        if ($('#perfAltOldIDBox').val() == '' || $('#perfAltNewMiniBox').val() == '' || $('#perfAltNewFotoBox').val() == '' || $('#perfAltNewCurriBox').val() == '') {
            $('#perfStatus').html('');
            $('#perfStatus').append("<ul><li>ERRO</li><ul>");
            $('#perfAltOldIDBox').val('');
            ...
            const requestURL = 'perfil/alt/' + $('#perfAltOldIDBox').val() + '/' + $('#perfAltNewMiniBox').val() + '/' + $('#perfAltNewFotoBox').val() + '/' + $('#perfAltNewCurriBox').val();
            $.ajax({
                url: requestURL,
                type: 'GET',
                dataType: 'json',
